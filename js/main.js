  ...
  const booksRows = books.map(book => `
    <tr>
      ...
      <td class="btn-group d-flex justify-content-center">
        <button class="btn btn-info"    onclick="onReadBook('${book.id}')"   data-trans="read">Read</button>
        <button class="btn btn-warning" onclick="onUpdateBook('${book.id}')" data-trans="update">Update</button>
        <button class="btn btn-danger"  onclick="onDeleteBook('${book.id}')" data-trans="delete">Delete</button>
      </td>
    </tr>
  `)
    ...
    <table class="table table-striped table-bordered table-hover">
      <thead>
        <tr>
          ...
          <th scope="col" data-trans="name">Name</th>
          <th scope="col" data-trans="price">Price</th>
          <th scope="col" data-trans="rate">Rate</th>
          <th scope="col" data-trans="actions" class="text-center">Actions</th>
        </tr>
      </thead>
      <tbody>
        ${booksRows.join('')}
